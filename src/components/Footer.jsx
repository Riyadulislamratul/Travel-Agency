...
const Footer = () => {
  return (
    <Section className='bg-[#13253F] mt-10'>
      ...
      <div className='grid grid-cols-4 gap-40 justify-between pt-20 pb-25'>
       <div className='flex flex-col gap-3'>
         <div>
          ...
          <select
            className="w-full bg-transparent border border-gray-500 rounded px-4 py-3 appearance-none text-white focus:outline-none"
          >
            <option value="en" selected className='text-black'>English</option>
      ...
      {/* Currency */}
      <div>
        <h4 className="font-mulish text-[15px] text-white font-bold mb-2.5">Currency</h4>
        <div className="relative">
          <select
            className="w-full bg-transparent border border-gray-500 rounded px-4 py-3 appearance-none focus:outline-none text-white"
          >
            <option value="usd selected className='text-black">U.S. Dollar ($)</option>
            <option value="bdt"className='text-black'>Bangladeshi Taka (৳)</option>
          </select>
        ...
        <div>
          ...
          <p className='font-mulish text-[15px] text-white/60 text-nowrap'>Become a Tour guide for Us</p>
        </div>
